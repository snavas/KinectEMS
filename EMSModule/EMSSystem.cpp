...
int EMSSystem::getNextNumberOfSting(String *command, int startIndex) {
	//Serial.println("Entering getNextNumberOfString");
	int number = -1;
...
void EMSSystem::doActionCommand(String *command) {
	//Serial.println("Entering doActionCommand");
	if (command->length() != 0) {
		// Channel
...
void EMSSystem::setOption(String *option) {
	Serial.println("Entering SetOption");
...
void EMSSystem::doCommand(String *command) {
	//Serial.println("Entering EMSSystem.doCommand()");
